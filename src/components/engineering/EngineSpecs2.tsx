                ...
                {activeTab === "overview" && (
                  <div className="flex flex-col justify-evenly font-normal tracking-tight">
                    <p className="md:text-p text-[15px] text-[#d5d5d5]">
                      ...
                      maximize propulsion performance while minimizing
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-2">
                      <div>
                        ...
                        <p className="md:text-p text-[15px] text-[#999999] md:mt-3">
                          Our systems provide dynamic surge capability, enabling
                          long-duration thrust increases for maneuvering, orbit
                          adjustment, and mission-critical operations.
                        </p>
                      </div>
                      <div>
                        <h6 className="text-[17px] font-normal text-[#0088ff] md:text-[18px]">
                      ...
                      <div className="mt-2 sm:col-span-2 md:mt-4">
                        ...
                        <p className="md:text-p text-[15px] text-[#999999] md:mt-3">
                          With fewer critical components and streamlined design,
                          GIT RF systems lower manufacturing complexity and
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-2">
                      ...
                      <div className="mt-2 sm:col-span-2 md:mt-4">
                        ...
                        <p className="md:text-p text-[15px] text-[#999999] md:mt-3">
                          ...
                          for superior thrust utilization Cathode-less RF plasma
                          for higher efficiency and longer system lifetime
                          Seamless scalability across diverse power and mission
                          profiles
                        </p>
                      </div>
                    </div>
